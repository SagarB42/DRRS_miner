...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "457", "EstimateLatencyMax" : "457",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set ArgLastReadFirstWriteLatency {
	sha256d {
		...
		output_4_V {Type O LastRead -1 FirstWrite 7}
		output_5_V {Type O LastRead -1 FirstWrite 7}
		output_6_V {Type O LastRead -1 FirstWrite 7}
		output_7_V {Type O LastRead -1 FirstWrite 7}
		K_V {Type I LastRead -1 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "457", "Max" : "457"}
