...
// ==============================================================
#ifndef __sha256_transform_bkb_H__
#define __sha256_transform_bkb_H__
...
struct sha256_transform_bkb_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sha256_transform_bkb_ram) {
...
SC_MODULE(sha256_transform_bkb) {
...
sha256_transform_bkb_ram* meminst;


SC_CTOR(sha256_transform_bkb) {
meminst = new sha256_transform_bkb_ram("sha256_transform_bkb_ram");
