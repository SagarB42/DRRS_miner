...
// ==============================================================
#ifndef __sha256_transform_cud_H__
#define __sha256_transform_cud_H__
...
struct sha256_transform_cud_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sha256_transform_cud_ram) {
...
SC_MODULE(sha256_transform_cud) {
...
sha256_transform_cud_ram* meminst;


SC_CTOR(sha256_transform_cud) {
meminst = new sha256_transform_cud_ram("sha256_transform_cud_ram");
