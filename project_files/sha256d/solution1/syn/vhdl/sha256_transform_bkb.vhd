...
entity sha256_transform_bkb_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of sha256_transform_bkb_rom is 
...
entity sha256_transform_bkb is
    generic (
...
architecture arch of sha256_transform_bkb is
    component sha256_transform_bkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    sha256_transform_bkb_rom_U :  component sha256_transform_bkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
