set moduleName sha256_prepare_1
set isTopModule 0
...
set C_modelName {sha256_prepare_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_V int 8 regular {array 80 { 1 3 } 1 1 }  }
	{ data_V int 8 regular {array 128 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_V", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "data_V", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ data_V_we0 sc_out sc_logic 1 signal 1 } 
	{ data_V_d0 sc_out sc_lv 8 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "data_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "data_V", "role": "we0" }} , 
 	{ "name": "data_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "data_V", "role": "d0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.data1_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	data_V { ap_memory {  { data_V_address0 mem_address 1 7 }  { data_V_ce0 mem_ce 1 1 }  { data_V_we0 mem_we 1 1 }  { data_V_d0 mem_din 1 8 } } }
}
