...
set C_modelArgList {
	{ v_V int 32 regular {array 16 { 2 1 } 1 1 }  }
	{ a int 4 regular  }
	{ b int 4 regular  }
	{ c int 5 regular  }
	{ d int 5 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "v_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "a", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "b", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "c", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "d", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ v_V_address0 sc_out sc_lv 4 signal 0 } 
	{ v_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ v_V_we0 sc_out sc_logic 1 signal 0 } 
	{ v_V_d0 sc_out sc_lv 32 signal 0 } 
	{ v_V_q0 sc_in sc_lv 32 signal 0 } 
	{ v_V_address1 sc_out sc_lv 4 signal 0 } 
	{ v_V_ce1 sc_out sc_logic 1 signal 0 } 
	{ v_V_q1 sc_in sc_lv 32 signal 0 } 
	{ a sc_in sc_lv 4 signal 1 } 
	{ b sc_in sc_lv 4 signal 2 } 
	{ c sc_in sc_lv 5 signal 3 } 
	{ d sc_in sc_lv 5 signal 4 } 
	{ x_V sc_in sc_lv 32 signal 5 } 
	{ y_V sc_in sc_lv 32 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v_V", "role": "d0" }} , 
 	{ "name": "v_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v_V", "role": "q0" }} , 
 	...
 	{ "name": "v_V_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v_V", "role": "q1" }} , 
 	...
 	{ "name": "c", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "c", "role": "default" }} , 
 	{ "name": "d", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "d", "role": "default" }} , 
...
set Spec2ImplPortList { 
	v_V { ap_memory {  { v_V_address0 mem_address 1 4 }  { v_V_ce0 mem_ce 1 1 }  { v_V_we0 mem_we 1 1 }  { v_V_d0 mem_din 1 32 }  { v_V_q0 mem_dout 0 32 }  { v_V_address1 MemPortADDR2 1 4 }  { v_V_ce1 MemPortCE2 1 1 }  { v_V_q1 MemPortDOUT2 0 32 } } }
	a { ap_none {  { a in_data 0 4 } } }
	b { ap_none {  { b in_data 0 4 } } }
	c { ap_none {  { c in_data 0 5 } } }
	d { ap_none {  { d in_data 0 5 } } }
