...
architecture rtl of compress_IV_V_rom is 
...
architecture arch of compress_IV_V is
    component compress_IV_V_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    compress_IV_V_rom_U :  component compress_IV_V_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
