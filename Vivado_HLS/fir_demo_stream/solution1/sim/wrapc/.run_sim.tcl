...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sha256d.autotvin.dat"
	set constFileTvOut       "sha256d.autotvout.dat"
	set constFileHdlTvIn     "sha256d.autohdltvin.dat"
	set constFileHdlTvOut    "sha256d.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
