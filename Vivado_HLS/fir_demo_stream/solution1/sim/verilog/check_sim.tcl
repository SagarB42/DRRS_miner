...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.sha256d.autotvin_input_V_data_V.dat"
         "c.sha256d.autotvin_input_V_keep_V.dat"
         "c.sha256d.autotvin_input_V_strb_V.dat"
         "c.sha256d.autotvin_input_V_last_V.dat"
         "c.sha256d.autotvin_output_V_data_V.dat"
         "c.sha256d.autotvin_output_V_keep_V.dat"
         "c.sha256d.autotvin_output_V_strb_V.dat"
         "c.sha256d.autotvin_output_V_last_V.dat"
         "c.sha256d.autotvout_output_V_data_V.dat"
         "c.sha256d.autotvout_output_V_keep_V.dat"
         "c.sha256d.autotvout_output_V_strb_V.dat"
         "c.sha256d.autotvout_output_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.sha256d.autotvout_output_V_data_V.dat"
         "rtl.sha256d.autotvout_output_V_keep_V.dat"
         "rtl.sha256d.autotvout_output_V_strb_V.dat"
         "rtl.sha256d.autotvout_output_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
