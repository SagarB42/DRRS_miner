...
set DataType00 "[list ap_uint 640 ]"
...
set DataType01 "[list ap_uint 80 ]"
...
set DataType02 "[list ap_uint 80 ]"
...
set structArgument0 [list 640 0 0 0 ]
set NameSpace0 [list ]
set structIsPacked0 "0"
set DataType0 [list "ap_axiu<640, 0, 0, 0>" "struct ap_axiu" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
