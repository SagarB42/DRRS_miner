...
architecture rtl of sha256d_K_rom is 
...
architecture arch of sha256d_K is
    component sha256d_K_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    sha256d_K_rom_U :  component sha256d_K_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
