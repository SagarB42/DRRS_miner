...
HD_PWD='C:/comp4601/deliver/Vivado/baseDesign_stream/baseline_hls.runs/design_4_axi_dma_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_4_axi_dma_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_4_axi_dma_0_1.tcl
